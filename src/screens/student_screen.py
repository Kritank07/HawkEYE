...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_btn():
            if st.button("Unenroll from this course", type = "tertiary", width="stretch", icon = ':material/delete_forever:', key = f"unenroll_btn_{sid}_{i}"):
...
def student_screen():
    ...
    if show_registration :
        with st.container(border = True):
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like 'Hi, my name is Akash and I am present in today's class'")
